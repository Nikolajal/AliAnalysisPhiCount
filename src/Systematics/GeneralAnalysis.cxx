...
void
GeneralAnalysis
( TH1F* hStandard = new TH1F(), std::vector<TH1F*> hVariations = _DUMP ) {
    //
    std::vector<TH1F*> uVariations;
    std::vector<TH2F*> uVariation2;
    //
    ...
    for ( Int_t iTer = 1; iTer <= nOptions; iTer++ )
    {
        ...
        hName           =   Form("hRAW_1D");
        uVariations.push_back((TH1F*)(insFileH1D[iTer]->Get(hName)));
    ...
    for ( Int_t iTer = 0; iTer < nOption2; iTer++ )
    {
        ...
        hName           =   Form("hRAW_2D");
        uVariation2.push_back( (TH2F*)(insFileH2D[iTer]->Get(hName)) );
